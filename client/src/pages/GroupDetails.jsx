    ...
    if (Object.keys(GroupObj).length > 0) {
      ...
      dispatch(
        CreateOrder(
          ...
          qty,
          GroupObj && GroupObj?.retail_price,
          GroupObj && GroupObj?.format,
          dispatch
        )
      );
    }
          ...
          {GroupsEvents?.length > 0 ? (
            <div class="w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
              ...
              <div class="lg:mt-11 mt-10">
                ...
                <div className="flex justify-between place-items-center gap-4 my-2">
                  <div className="flex justify-between place-items-center gap-2 w-full ">
                    ...
                    <select
                      className=" border-[1px] px-3 py-1 w-[200px] bg-color4 text-color2 outline-none"
                      value={section}
                      onChange={(e) => {
                ...
                <div class="flex flex-row justify-between">
                  ...
                  {GroupObj && Object.keys(GroupObj).length !== 0 && row ? (
                    <>
                      <select
                        className=" border-[1px] w-[200px] px-2 py-1  bg-color4 text-color2 outline-none"
                        value={qty}
              ...
              <div className="flex justify-between place-items-center gap-4">
                <button
                  class="focus:outline-none flex justify-center place-items-center gap-2  focus:ring-2  focus:ring-offset-2 disabled:cursor-no-drop disabled:bg-gray-700 focus:ring-gray-800 font-medium text-base leading-4 text-color2 bg-color4 w-full py-5 lg:mt-12 mt-6 "
                  disabled={
