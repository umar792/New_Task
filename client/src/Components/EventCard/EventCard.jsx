...
const EventCard = ({ item, index, image }) => {
  return (
    <NavLink
      to={`/tickets/group.details/${item?.id}`}
      className="card_image w-[300px] h-[370px] flex flex-col pt-[50px] overflow-hidden relative z-[21] !bg-color1 !text-color2   rounded-lg hover:shadow-md border-[1px] border-color4 "
    >
      <img
        className="rounded-t-lg w-full  object- z-[2] duration-200"
