                    ...
                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                      ...
                      <div className="mt-6">
                        <button
                          ...
                          onClick={ordernow}
                          className="flex items-center justify-center rounded-md border border-transparent w-full bg-redColor disabled:bg-red-500 disabled:cursor-no-drop px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
                        >
